...
void CHideButton::DrawControl(CDC &dc, CRect rcUpdate)
{
	...
	{		
		...
		for(int i = 0; i < 4; i++)
		{
			RectF rect(i * (Gdiplus::REAL)nWidth, (Gdiplus::REAL)point.y, (Gdiplus::REAL)sizeTip.Width + 10, (Gdiplus::REAL)sizeTip.Height);
			...
			if(i > 0)
			{
				...
				RectF rect((Gdiplus::REAL)sizeTip.Width + 10 + i * nWidth, (Gdiplus::REAL)point.y, nWidth - ((Gdiplus::REAL)sizeTip.Width + 10), (Gdiplus::REAL)sizeText.Height);
