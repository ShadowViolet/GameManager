...
CTab::CTab(HWND hWnd, CMessageInterface* pMessage, UINT uControlID, CRect rc, CString strTitle/*= TEXT("")*/, BOOL bIsVisible/* = TRUE*/, BOOL bIsDisable/* = FALSE*/ ,BOOL bIsPressDown/* = FALSE*/)
...
BOOL CTab::InsertItem(unsigned nItem, ItemInfo &itemInfo)
{
...
int CTab::SetSelectItem(unsigned nItem)
{
